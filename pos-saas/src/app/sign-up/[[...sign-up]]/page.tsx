    ...
    return (
        <AuthLayout>
            <div className="flex flex-col space-y-4 text-center mb-6">
                <h2 className="text-2xl font-bold tracking-tight text-white">Únete a POSMaster</h2>
                <p className="text-sm text-zinc-400">Crea tu cuenta y comienza a gestionar tu negocio.</p>
            </div>
            <SignUp
                appearance={{
                    elements: {
